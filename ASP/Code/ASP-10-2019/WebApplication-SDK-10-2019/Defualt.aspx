<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Defualt.aspx.cs" Inherits="WebApplication_SDK_10_2019.Defualt" %>
                                        ...
                                        <div class="row">
                                            <div class="tab-content-services">
                                                <div class="col-md-6">
                                                    <div class="left-text">
                                                        <h4>Unique Ideas</h4>
                                                        <p>Power is free Bootstrap CSS template from Templatemo website. Feel free to modify and use this layout. Please tell your friends about our website. Mixtape hella beard meditation, organic polaroid waistcoat humblebrag taxider my tumblr. Hexagon kinfolk chartreuse shoreditch.
                                                            <br>
                                                            <br>
                                                            Pour-over hammock intelligentsia hashtag air plant distillery. Sustainable selvage hashtag, +1 messenger bag pop-up banh mi jianbing art party roof party try-hard retro small batch. Kogi fanny pack raclette mustache, pok pok jean shorts +1 tote bag keffiyeh. Post-ironic af master polaroid.</p>
                                                        <div class="primary-button">
                                        ...
                                        <div class="row">
                                            <div class="tab-content-services">
                                                <div class="col-md-6">
                                                    <div class="left-text">
                                                        <h4>Theme Edit</h4>
                                                        <p>Lomo austin health goth meditation quinoa, banh mi pork belly man bun hella ugh migascardigan gluten-free. Gochujang dreamcatcher tofu brunch banjo. VHS austin cardigan squid poke tumeric humblebrag next level everyday carry biodiesel put a bird on it raw denim. Fanny pack aesthetic kinfolk twee
                                                            <br>
                                                            <br>
                                                            succulents roof party wayfarers meggings ugh tumblr shaman kale chips green. Before they sold out live-edge kinfolk man bun pop-up scenester ramps taiyaki tacos raclette mixtape la croix post-ironic leggings. Twee typewriter taxidermy, woke farm-to-table hell of cliche celiac meggings.</p>
                                                        <div class="primary-button">
                                                            <a href="#contact-us">Download Now</a>
                                                        </div>
                                                    </div>
                            ...
                            <div class="item">
                                <div class="portfolio-item">
                                    <a href="img/first-portfolio-big.jpg" title="">
                                        <img src="img/first-portfolio-item.jpg" alt="Gallery image 1" /></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="portfolio-item">
                                    <a href="img/second-portfolio-big.jpg" title="">
                                        <img src="img/second-portfolio-item.jpg" alt="Gallery image 1" /></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="portfolio-item">
                                    <a href="img/third-portfolio-big.jpg" title="">
                                        <img src="img/third-portfolio-item.jpg" alt="Gallery image 1" /></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="portfolio-item">
                                    <a href="img/fourth-portfolio-big.jpg" title="">
                                        <img src="img/fourth-portfolio-item.jpg" alt="Gallery image 1" /></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="portfolio-item">
                                    <a href="img/first-portfolio-big.jpg" data-lightbox="image-1">
                                        <img src="img/first-portfolio-item.jpg"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="portfolio-item">
                        ...
                        <div class="wrapper">
                            <div class="col-md-6">
                                <ul class="tabs clearfix" data-tabgroup="first-tab-group">
                                    <li><a href="#tab1" class="active">shoreditch wolf ethical hashtag
                                    <ul class="info-post">
                                    ...
                                    <li><a href="#tab2">kickstarter master cleanse scenester
                                    <ul class="info-post">
                                    ...
                                    <li><a href="#tab3">Seitan flexitarian prism shaman
                                    <ul class="info-post">
                                    ...
                                    <li><a href="#tab4">Fashion axe selvage everyday carry
                                    <ul class="info-post">
                                        <li><i class="fa fa-user"></i>Krist</li>
                                    ...
                                    <li><a href="#tab5">chambray truffaut godard flannel
                                    <ul class="info-post">
                                        <li><i class="fa fa-user"></i>Admin</li>
                        ...
                        <div class="col-md-6">
                            <div id="contact">
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            <asp:TextBox ID="TextBoxName" CssClass="form-control" placeholder="Name" runat="server"></asp:TextBox>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                            <asp:TextBox ID="TextBoxSubject" placeholder="subject" CssClass="form-control" runat="server"></asp:TextBox>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset>
                                            <asp:TextBox ID="TextBoxPhone" CssClass="form-control" placeholder="Phone" runat="server"></asp:TextBox>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12">
                                        <fieldset>
                                            <asp:TextBox ID="TextBoxMsj" CssClass="form-control" placeholder="Message" runat="server" TextMode="MultiLine"></asp:TextBox>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12">
                                        <fieldset>
