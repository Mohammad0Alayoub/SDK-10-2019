...
namespace Files
{
   ...
   class TXTtoHTML { static void Main() { Console.Write("Enter name of file: "); string nameTXT = Console.ReadLine(); string nameHTML = nameTXT.Substring(0, nameTXT.Length - 4); if (File.Exists(nameTXT)) { StreamReader fileTXT = File.OpenText(nameTXT); StreamWriter fileHTML = File.CreateText(nameHTML + ".html"); fileHTML.WriteLine(""); fileHTML.WriteLine(""); fileHTML.WriteLine(""); fileHTML.WriteLine(""); fileHTML.WriteLine("");string line; do { line = fileTXT.ReadLine(); if (line != null) fileHTML.WriteLine(" " + line + " "); } while (line != null); fileHTML.WriteLine(""); fileHTML.WriteLine(""); fileTXT.Close(); fileHTML.Close(); } }
}
